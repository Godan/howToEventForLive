...
ある日の都内のとある実際の会社で起こったチャットログです。@<br>{}
これをきっかけに平成最後の期間を配信という作業に追われていくことになります。@<br>{}
 ...
 * 上司に今後はYoutube Liveでリアルタイムでつながる時代だよ!と言われた方
...
この本では途中配信ソフトを使った内容を取扱います。その際に使用したPCスペックは次の通りです。
