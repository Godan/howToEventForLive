...
右上のメニューから@<code>{新しいライブ配信}をクリックして新しいライブを作成します。
//image[stream][ライブ作成画面][scale=0.5]
...
画像検索窓で@<code>{mic}や@<code>{cam}で検索するといい感じのアイコンを用意してくれます。また矢印なども引きやすくそれに対してコメントもできるのでお手軽に配置図を書くことが出来ます。


//image[haitchi][配置図サンプル][scale=0.7]
...
//image[terop][著者がよく作るテロップ例][scale=0.5]
