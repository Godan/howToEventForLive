...
ここでは本書でとりあげる配信形体とそれぞれに必要な物を説明していきます。@<br>{}
...
一番気楽な配信形体形体です。@<br>{}
なにせ既存のWebカメラやパソコンさえ有れば今からでもできる配信形態です。@<br>{}
...
高画質で配信したい際はハンディビデオカメラを購入しましょう。@<br>{}
...
HDMIがついていいる場合はFullHDに対応している事が多いと思いますが、場合によっては出力時のサイズが低かったりします。またSDカードとおもったらメモリースティックだったなんてこともあるので気をつけましょう。本書を読んだ方は著者の二の舞を踏まないようお願いします…

====== ビデオキャプチャ


ビデオキャプチャはゲームや、ビデオの映像信号をパソコン上で取り扱えるようにする機械のことです。@<br>{}
ビデオカメラの中には直接パソコンのWebカメラになる機種もありますが、基本的にはHDMI出力をビデオキャプチャで変換するのが一般的です。
ゲーム画面などを取り込む目的でも使われます。@<br>{}
...
実際の番組みたいに映像を切り替えたり、映像を重ねるPinP(ピクチャー・イン・ピクチャー)が実際にできる配信形態です。@<br>{}
...
今までは業務用の機材であり、価格も高価格帯なものしかありませんでしたが、近年YoutuberやVtuber、ニコ生などの個人による配信需要というのが大きく伸びてきました。
...
デジタル時計で秒まで見ることができるものがおススメです。@<br>{}
...
配信中は飲み物も買いに行けないことが多いです。@<br>{}
著者はよくコンビニで売っている1Lの大きめのペットボトル飲料を買っておくようにしています。
炭酸が入っているものは開封時に音が出るためマイクの近くに居ることが多い配信時は避けておくのが無難です。@<br>{}
また、保管は機材とは別テーブルにするか床に置くなどして配信機材を濡らさないように気をつけましょう。

=== トランシーバー


少ない人数でやるとどうしても普段カメラを触ったことがない人にカメラをお願いすることになります。@<br>{}
その場合どうしても配信するには少し辛い画になることがあります。@<br>{}
その場合の指示を出すのにトランシーバーは便利です。  わざわざカメラまで毎回いくこともなくなるのでおすすめです。また、イベント主催者などに持たせて置くとなにか困ったときに指示が仰げるのでおすすめです。
購入時に気をつけないといけないのは電波法でしょう。


特定小型無線は免許が無くても使用できますが、それ以上のものは免許が必要になってきます。わざわざ取るわけにもいかないので特定小型無線を購入しましょう。
Amazonにある中華製は電波法律で認められていない電波帯を使っているものが@<strong>{ものすごく多い}です。無線に関しては厳しく取り締まっていることもあるらしく無断で使用し続けてたら警察が来たなんて笑い話にならないケースもあるそうです。おとなしく技適認可品を買いましょう。
可能であれば型番から本当に技適を取得しているかも確認しましょう。Amazonの商品の中には架空の技適の番号を使用している用品も有ります。  
